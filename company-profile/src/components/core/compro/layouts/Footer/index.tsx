...
const Footer = () => {
  ...
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-gray-900 dark:bg-gray-900 pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="-mx-4 flex flex-wrap">
            ...
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                <Link
                  ...
                  href="#"
                  className="px-3 text-gray-400 dark:text-gray-300 hover:text-blue-400 dark:hover:text-blue-300"
                >
                  <svg
                    width="22"
                    height="22"
                    ...
                    className="fill-current hover:scale-125 duration-300"
                  >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white dark:text-white">
                {footerData.sections.about.title}
              </h4>
              <ul>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white dark:text-white">
                {footerData.sections.features.title}
              </h4>
              <ul>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white dark:text-white">
                {footerData.sections.products.title}
              </h4>
              <ul>
                {footerData.sections.products.links.map((link, index) => (
                  <li key={index}>
                    <Link
                      href={link.url}
                      className="mb-3 inline-block text-base text-gray-400 dark:text-gray-300 hover:text-blue-400 dark:hover:text-blue-300"
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white dark:text-white">
                {footerData.sections.links.title}
              </h4>
              <ul>
                {footerData.sections.links.links.map((link, index) => (
                  <li key={index}>
                    <Link
                      href={link.url}
                      className="mb-3 inline-block text-base text-gray-400 dark:text-gray-300 hover:text-blue-400 dark:hover:text-blue-300"
      ...
      <div className="mt-12 border-t border-[#8890A4] dark:border-gray-700 border-opacity-40 dark:border-opacity-40 py-8 lg:mt-[60px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <Link
                    href="#"
                    className="px-3 text-base text-gray-400 dark:text-gray-300 hover:text-white dark:hover:text-white hover:underline"
                  >
                    {footerData.bottom.privacy}
                  </Link>
                  <Link
                    href="#"
                    className="px-3 text-base text-gray-400 dark:text-gray-300 hover:text-white dark:hover:text-white hover:underline"
                  >
                    {footerData.bottom.legal}
                  </Link>
                  <Link
                    href="#"
                    className="px-3 text-base text-gray-400 dark:text-gray-300 hover:text-white dark:hover:text-white hover:underline"
                  >
                    {footerData.bottom.terms}
                  </Link>
                </div>
              </div>
            </div>
